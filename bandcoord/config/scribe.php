...
return [
    ...
    'sources' => [
        'endpoints' => [
            'include' => [
                // Rutas específicas que quieres documentar
                'api/*'
            ],
        ],
        'docs' => [
            // Archivos markdown adicionales para incluir en la documentación
            'extra_documentation' => [
                'models' => storage_path('docs/models.md'),
                'middleware' => storage_path('docs/middleware.md'),
            ],
        ],
    ],
];
